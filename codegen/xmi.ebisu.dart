...
'''
        ..dependencies = [
          ...
          pubdep('ebisu_web_ui')
          ..gitRef = 'HEAD'
          ..path = 'git://github.com/patefacio/ebisu_web_ui',
        ]
                 )
    ..rootPath = _topDir
    ..libraries = [
      library('xmi_polymer') 
      ..imports = [
        'package:ebisu_web_ui/ebisu_web_ui.dart',
        'package:ebisu/ebisu_id.dart',
        'package:xmi/xmi.dart',
      ]
      ..doc = 'Supports generating polymer web component library from a model'
      ..parts = [
        part('model_mapping')
        ..classes = [
          class_('model_mapping')
          ..doc = 'Maps a UModel to a collection of components'
          ..members = [
            member('model')
            ..doc = 'UML Model source for components'
            ..type = 'UModel'
            ..ctors = [''],
            member('id')
            ..doc = 'Id for this component library'
            ..type = 'Id'
            ..ctors = [''],
          ]
        ]
